...
// Object.keys(base).forEach(function (property) {
//     // eslint-disable-next-line no-prototype-builtins
//     if (!module.exports.hasOwnProperty(property)) {
//         module.exports[property] = base[property];
//     }
// });
...
function copyShippingAddressToShipment(shippingData, shipmentOrNull) {
    ...
    Transaction.wrap(function () {
        ...
        shippingAddress.secondName=shippingData.address.secondName;
